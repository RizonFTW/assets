export enum Permission {
	...
	ResetApiTokens = "reset_api_tokens", // Reset {entity} Token => Reset the API token of a {entity} on the team. This is seperate from viewing existing {entity} tokens as that is a much greater security risk
